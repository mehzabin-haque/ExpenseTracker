...
public class TextEditor extends SceneSwitch implements Initializable{
    @FXML
    ...
    @FXML
    public Label lbl_FontSize = new Label();
    @FXML
    public Slider s = new Slider();
    @FXML
    ...
    public void Last1(ActionEvent event) throws IOException {
        sceneSwitching("../SwitchScene/Last.fxml" , event);
    }
